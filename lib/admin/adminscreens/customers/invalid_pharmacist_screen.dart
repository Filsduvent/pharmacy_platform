...
class InvalidPharmacistScreen extends StatefulWidget {
  const InvalidPharmacistScreen({Key? key}) : super(key: key);

  @override
  State<InvalidPharmacistScreen> createState() =>
      _InvalidPharmacistScreenState();
}

class _InvalidPharmacistScreenState extends State<InvalidPharmacistScreen> {
  @override
